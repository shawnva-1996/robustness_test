...
# --- Configuration ---
INPUT_FILENAME = '2_processed_with_splits.csv'
OUTPUT_FILENAME = '2_modelling_results.csv'
TARGET_VARIABLE = 'log_likes'
# ---------------------

print("Starting model training with hyperparameter tuning for all models...")
...
# # --- FIX: Remove target leakage features and other identifiers ---
# features_to_drop = [
...
#     'Like Count', 'Play Count',  # Removing leaky features
#     TARGET_VARIABLE
# ]
...
print(f"\nUsing {len(numerical_features)} numerical features and {len(categorical_features)} categorical features.")
...
# --- NEW: Define parameter grids for all models ---
param_grids = {
