...
OUTPUT_FILENAME = '5_modelling_results_final_no_leakage.csv'
TARGET_VARIABLE = 'log_likes'
# ---------------------

print("Starting model training on the final dataset with target leakage removed...")
...
# --- CRITICAL FIX: Remove target leakage features and other identifiers ---
# features_to_drop = [
...
#     'log1p_play_count', # Also a potential leaky feature
#     'duration_s', # Redundant with 'Video Duration (s)'
#     'Like Count', # THIS IS THE TARGET LEAKAGE FEATURE TO REMOVE
#     TARGET_VARIABLE
# ]
features_to_drop = [
