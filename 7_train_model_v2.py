...
OUTPUT_FILENAME = '8_modelling_results_TRUE_PREDICTION.csv'
TARGET_VARIABLE = 'log_likes'
# ---------------------

print(f"Starting final model training on: '{INPUT_FILENAME}'")
print("Ensuring NO target leakage of any kind...")
...
#     'viral',            # CRITICAL: This is a PROXY for the target and must be removed
...
#     'transcript',       # Drop the raw transcript text, use the features derived from it
